...
from apps.scxrd.models.cif_model import validate_cif_file_extension
from apps.scxrd.models.models import Machine, CrystalSupport, validate_checkcif_file_extension, \
    validate_reportdoc_file_extension
from apps.scxrd.models.measurement_model import Measurement
from apps.scxrd.utils import COLOUR_MOD_CHOICES, COLOUR_LUSTRE_COICES, COLOUR_CHOICES
...
class MeasurementFormMixin(forms.ModelForm):
    ...
    measure_date = forms.DateTimeField(widget=DatePickerInput(
        options={
