...
from apps.scxrd.models.models import sample_name_validator, Machine, resolution_validator, CrystalSupport, CrystalGlue
from apps.scxrd.utils import COLOUR_CHOICES, COLOUR_MOD_CHOICES, COLOUR_LUSTRE_COICES
...
class Measurement(models.Model):
    ...
    resolution = models.FloatField(verbose_name=_('Resolution'), null=True, blank=True,
