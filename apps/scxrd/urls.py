...
from apps.scxrd.views.measurement_views import MeasurementIndexView, MeasurementCreateView, MeasurementFromSampleCreateView, \
    MeasurementEditView, MeasurementListJson, MeasurementsListJsonUser
from apps.scxrd.views.sample_views import MySamplesList, NewSampleByCustomer, OperatorSamplesList, SampleDeleteView, \
    OperatorSampleDetail, NewSampleOKView
from apps.scxrd.views.views import ResidualsTable, MoleculeView
from messlog.mysite.views import HomePageView
