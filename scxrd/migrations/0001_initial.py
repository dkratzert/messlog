# Generated by Django 2.1.5 on 2019-01-16 10:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crystal_colour_mod', models.IntegerField(blank=True, choices=[(0, 'not applicable'), (1, 'light'), (2, 'dark'), (3, 'whitish'), (4, 'blackish'), (5, 'grayish'), (6, 'brownish'), (7, 'reddish'), (8, 'pinkish'), (9, 'orangish'), (10, 'yellowish'), (11, 'greenish'), (12, 'bluish')], default=0)),
                ('crystal_colour_lustre', models.IntegerField(blank=True, choices=[(0, 'not applicable'), (1, 'metallic'), (2, 'dull'), (3, 'clear')], default=0)),
        ...
        migrations.AddField(
            ...
            name='customer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='experiment', to='scxrd.Person'),
        ),
        migrations.AddField(
            model_name='experiment',
            name='glue',
