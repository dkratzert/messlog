# Generated by Django 2.1.5 on 2019-01-14 11:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cif_file_on_disk', models.FileField(blank=True, null=True, upload_to='cifs')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crystal_colour', models.IntegerField(choices=[(0, '?'), (1, 'colourless'), (2, 'white'), (3, 'black'), (4, 'gray'), (5, 'brown'), (6, 'red'), (7, 'pink'), (8, 'orange'), (9, 'yellow'), (10, 'green'), (11, 'blue'), (12, 'violet')], default=0)),
                ('crystal_colour_mod', models.IntegerField(choices=[(0, '?'), (1, 'light'), (2, 'dark'), (3, 'whitish'), (4, 'blackish'), (5, 'grayish'), (6, 'brownish'), (7, 'reddish'), (8, 'pinkish'), (9, 'orangish'), (10, 'yellowish'), (11, 'greenish'), (12, 'bluish')], default=0)),
                ('crystal_colour_lustre', models.IntegerField(choices=[(0, '?'), (1, 'metallic'), (2, 'dull'), (3, 'clear')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cif', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='scxrd.CifFile')),
            ],
        ),
        migrations.AddField(
            model_name='experiment',
            name='machine',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='experiments', to='scxrd.Machine', verbose_name='diffractometer'),
        ),
        migrations.AddField(
            model_name='experiment',
            name='operator',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='experiments', to=settings.AUTH_USER_MODEL, verbose_name='operator'),
        ),
        migrations.AddField(
            model_name='experiment',
            name='solvents_used',
