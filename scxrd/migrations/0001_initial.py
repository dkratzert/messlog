# Generated by Django 2.1.7 on 2019-02-20 09:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sum_formula', models.CharField(blank=True, max_length=300, verbose_name='sum formula')),
                ('prelim_unit_cell', models.CharField(blank=True, max_length=250, verbose_name='assumed formula')),
        ...
        migrations.AddField(
            ...
            name='absfile',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiments', to='scxrd.SadabsModel', verbose_name='sadabs list file'),
        ),
        migrations.AddField(
            model_name='experiment',
            name='base',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='scxrd.CrystalSupport', verbose_name='sample base'),
        ),
        migrations.AddField(
            model_name='experiment',
            name='cif',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiments', to='scxrd.CifFile', verbose_name='cif file'),
        ),
        migrations.AddField(
            model_name='experiment',
            name='customer',
