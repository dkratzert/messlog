    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solvent1', models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment1', to='scxrd.Solvent', verbose_name='solvent 1')),
                ('solvent2', models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment2', to='scxrd.Solvent', verbose_name='solvent 2')),
                ('solvent3', models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment3', to='scxrd.Solvent', verbose_name='solvents 3')),
            ],
            options={
                'ordering': ['-number'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cif', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='scxrd.CifFileModel')),
            ],
        ),
    ]
