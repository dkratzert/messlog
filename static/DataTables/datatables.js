 ...
 *   https://datatables.net/download/#bs4/dt-1.10.21/kt-2.5.2/sp-1.1.1/sl-1.3.1
 *
 * Included libraries:
 *   DataTables 1.10.21, KeyTable 2.5.2, SearchPanes 1.1.1, Select 1.3.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.21/kt-2.5.2/sp-1.1.1/sl-1.3.1",
