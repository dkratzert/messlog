...
// this library is organized into the following sections:
    ...
    Jmol._getWrapper = function (applet, isHeader) {
        ...
        if (isHeader) {
            ...
            s = "\
...<div id=\"ID_appletinfotablediv\" style=\"width:96%;height:Hpx;position:relative;font-size:14px;text-align:left\">IMG WAIT\
......<div id=\"ID_appletdiv\" style=\"z-index:" + Jmol._getZ(applet, "header") + ";width:100%;height:100%;position:absolute;top:2px;left:2px;" + css + ">";
