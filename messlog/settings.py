"""
Django settings for messlog project.
...
WSGI_APPLICATION = 'messlog.wsgi.application'
...
FIXTURE_DIRS = [os.path.join(BASE_DIR, "apps/scxrd/fixtures/")]
